...
class ApiService {
  static const String apiKey = 'Lnh4vtS3k9f6q1p/IH+dew==Oml0r22EKCj9xbwP'; // Ini tidak digunakan
  ...
  Future<List<Predict>> fetchPredicts() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<Predict> predicts = data.map((json) => Predict.fromJson(json)).toList();

        for (var predict in predicts) {
          await _databaseHelper.insertPredict(predict);
        }
